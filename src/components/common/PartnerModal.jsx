...
const PartnerModal = ({ show, handleClose, handleSave, editMode = false, partnerData = null, setSelectedFile, selectedFile }) => {
  ...
  // Reset form when modal opens or partnerData changes
  React.useEffect(() => {
    if (show) {
  ...
  }, [show, editMode, partnerData, reset, setSelectedFile]);
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (selectedFile) {
        partnerDataWithRole.profile_image = selectedFile;
      }
      
      await handleSave(partnerDataWithRole);
      reset();
      setFileError('');
    } catch (error) {
        ...
        <div className="modal-content">
          <div className="modal-header border-bottom">
            <h5 className="modal-title fw-semibold">
              {editMode ? 'Edit Partner' : 'New Partner Information'}
            </h5>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="modal-footer border-top">
              ...
              <CustomButton variant="primary" type="submit" loading={isSubmitting}>
                ...
                {editMode ? 'Update Partner' : 'Save Partner'}
              </CustomButton>
            </div>
          </form>
        </div>
